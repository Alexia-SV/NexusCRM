    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="max-w-5xl w-full flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(15,23,42,0.08)] border border-slate-100">
        <div className="w-full md:w-7/12 p-8 md:p-12 flex flex-col justify-center min-h-[580px]">
          ...
          <form className="space-y-5" onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div>
              ...
              <input autoComplete="current-password" type="password" className={inputClass} placeholder="••••••••"
                {...register('password', { required: 'La contraseña es obligatoria' })} />
              {errors.password && <span className="text-xs text-rose-600 mt-1 block">{errors.password.message}</span>}
            </div>
        ...
        <div className="w-full md:w-5/12 bg-slate-900 p-8 md:p-12 flex flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="my-12 space-y-4"><h1 className="text-4xl md:text-5xl font-serif leading-tight">Gestiona tu equipo con <span className="italic text-sky-300">precisión</span>.</h1><p className="text-sm text-slate-400 leading-relaxed">Control total de empleados, proyectos y recursos desde un solo lugar.</p></div>
